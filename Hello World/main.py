...
def genetic_algorithm(pop_size, generations, mutation_rate, crossover_rate, elitism_ratio):
...
result = genetic_algorithm(population_size, generations, mutation_rate, crossover_rate, elitism_ratio)
print(result)
